...
with open('entrada2.txt','r') as f: #C:\\Users\\bruno\\OneDrive\\Documentos\\GitHub\\Lab1-Shell_sort\\
    tamanho = [int(r.split()[0]) for r in f]
#Exercicio 2:
#tamanho = [100, 1000, 10000, 100000, 1000000]
f = open('entrada2.txt', 'r') #C:\\Users\\bruno\\OneDrive\\Documentos\\GitHub\\fafafa\\fafasfa\\
for i in tamanho:
    data = f.readline()
    #converte a string em uma lista de inteiros
    res1 = [int(i) for i in data.split()]
